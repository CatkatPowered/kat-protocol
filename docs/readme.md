<h1 align="center">⚡️ Kat Protocol</h1>
...
本项目具有 [使用条款](https://project.catkatpowered.com/#/terms-of-use) 和 [开源声明](https://project.catkatpowered.com/#/open-source-license)
...
- [通信方式 websocket / websockets](websocket.md)
  ...
  - [插件描述包](websocket-description-extension-packet.md)
